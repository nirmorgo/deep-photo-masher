...
def build_full_conv_autoencoder(self):
    ...
    with tf.variable_scope('conv1'):
        conv1 = conv_inst_norm(self.X, num_filters=32, filter_size=5, strides=1)
...
def build_vae_128(self):
    ...
    with tf.variable_scope('embedded_space'):
        ...
        self.z_log_sigma_sq = fully_connected(encoder_out, 512, activation_fn=None, scope='z_sigma')
